...
let producto = prompt("Podemos ofrecerte: remeras, busos, jeans y camperas. Elegí uno para saber más")
...
let respuesta = prompt(`Para seguir ingresá "1". Para finalizar ingresá "0".`)
...
switch (respuesta) {
    case "1":
        ...
        break;
    default:
        console.log("Opción inválida. Se finalizan compras.");
        break;
}